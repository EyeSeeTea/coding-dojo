...
var GildedRose_1 = require("./GildedRose/GildedRose");
var ItemInMemoryProvider_1 = require("./ItemInMemoryProvider/ItemInMemoryProvider");
var BackstageItem_1 = require("./items/BackstageItem");
var BasicItem_1 = require("./items/BasicItem");
var BrieItem_1 = require("./items/BrieItem");
var ConjuredItem_1 = require("./items/ConjuredItem");
var SulfurasItem_1 = require("./items/SulfurasItem");
function main() {
    var itemProvider = new ItemInMemoryProvider_1.ItemInMemoryProvider([
        new BasicItem_1.BasicItem("+5 Dexterity Vest", 10, 20),
        new BrieItem_1.BrieItem(2, 0),
        new BasicItem_1.BasicItem("Elixir of the Mongoose", 5, 7),
        new SulfurasItem_1.SulfurasItem(),
        new BackstageItem_1.BackstageItem(15, 20),
        new ConjuredItem_1.ConjuredItem(3, 6),
    ]);
    var gridedRose = new GildedRose_1.GildedRose(itemProvider);
    var updatedItems = gridedRose.updateQuality();
    console.log(updatedItems.map(function (item) { return item.toString(); }).join("\n"));
}
main();
