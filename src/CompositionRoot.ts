...
import { ExportProductsToExcelUseCase } from "./domain/usecases/ExportProductsToExcelUseCase";
...
function getCompositionRoot(repositories: Repositories, api?: D2Api) {
    return {
        ...
        products: {
            ...
            exportToExcel: new ExportProductsToExcelUseCase(repositories.productExportRepository),
        },
    };
}
